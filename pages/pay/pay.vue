<template>
	<view class="container">
		<view class="bg-white d-flex p-30 align-items-center justify-content-between mb-20">
			<view>
				...
				<view class="w-100 d-flex align-items-center overflow-hidden">
					<scroll-view class="flex-fill overflow-hidden" scroll-x>
						<view class="w-100 d-flex align-items-center">
							<image class="pro-img" :src="item.image" v-for="(item, index) in cart" :key="index"></image>
						</view>
					</scroll-view>
		...
		<list-cell last>
			<view class="w-100 d-flex align-items-center justify-content-between">
				<view>支付方式</view>
				<view class="d-flex align-items-center">
					<image class="wx-pay-icon" src="/static/images/order/weixin-pay.png"></image>
					<view>微信</view>
				</view>
			</view>
		</list-cell>
